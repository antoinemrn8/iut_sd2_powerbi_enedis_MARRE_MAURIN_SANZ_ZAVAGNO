...
**❓ ProblématiqueDans quelle mesure le niveau de richesse d'un département, mesuré par le revenu fiscal moyen par foyer, influence-t-il la performance énergétique des logements évaluée par les étiquettes DPE ?
📍 Territoires Étudiés**
Nous avons choisi de confronter deux départements aux profils socio-économiques diamétralement opposés pour tester notre hypothèse :**DépartementProfil ÉconomiqueRevenu Fiscal Moyen / FoyerAin (01)**Territoire "Riche"**36 651 € / anGard (30)**Territoire "Modeste"**26 885 € / an
...
**🚀 Objectif Final**
Fournir un outil d'aide à la décision pour les acteurs de la transition écologique, permettant d'identifier si les politiques de rénovation doivent être davantage ciblées en fonction des disparités de revenus territoriaux.
